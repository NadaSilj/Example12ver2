...
import rs.aleph.android.example15.provider.JeloProvider;
...
public class SecondActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputStream is = null;
        try {
            is = getAssets().open(JeloProvider.getFruitById(position).getImage());
        ...
        tvName.setText(JeloProvider.getFruitById(position).getName());

        // Finds "tvDescription" TextView and sets "text" property
        TextView tvDescription = (TextView) findViewById(R.id.tv_description);
        tvDescription.setText(JeloProvider.getFruitById(position).getDescription());
        ...
        category.setSelection((int) JeloProvider.getFruitById(position).getCategory().getId());

        // Finds "rbRating" RatingBar and sets "rating" property
        RatingBar rbRating = (RatingBar) findViewById(R.id.rb_rating);
        rbRating.setRating(JeloProvider.getFruitById(position).getRating());
        ...
        btnBuy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast toast = Toast.makeText(v.getContext(), "You've bought " + JeloProvider.getFruitById(position).getName() + "!", Toast.LENGTH_LONG);
                toast.show();
            }
        });
